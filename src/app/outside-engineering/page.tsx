...
const interests = [
  ...
  },
  {
    ...
    copy: "Although I've been making bread for nearly 10 years, I only began experimenting with sourdough about four years ago. Since then, I've kept—and killed—several starters. My current starter is more than three years old and is named Gary.",
    images: [
